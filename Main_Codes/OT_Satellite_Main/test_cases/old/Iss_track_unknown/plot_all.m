...
ylabel_names = {'p (Km)','f','g','h','k','L (rad)'};
...
for i = 1:6
    ...
    title('Ensemble Size = 50','FontSize',16);
    s2 = subplot(2,3,2);
    ...
    title('Ensemble Size = 60','FontSize',16);
    s3 = subplot(2,3,3)
    ...
    title('Ensemble Size = 70','FontSize',16);
    hL = legend([a1,c1],'OT est. states','Real states');
    set(hL,'Position',[0.466 0.496 0.104 0.04],'FontSize',11);
    ...
    set(hL,'Position',[0.463 0.025 0.114 0.04],'FontSize',11);
