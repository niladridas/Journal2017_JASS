...
%     ax.FontWeight = 'bold';
    ...
    if i == 1
        title('OT (samples=70,repeat=10)','FontSize',18,'interpreter', 'latex','FontWeight','bold');
    end
    ax2 = subplot(7,2,2*i);
    % PLot EnKF
...
%     ax.FontWeight = 'bold';
    ...
    if i == 1
        title('EnKF (samples=70,repeat=10)','FontSize',18,'interpreter', 'latex','FontWeight','bold');
    end
%     linkaxes([ax1,ax2],'xy')
end
hL = subplot(7,2,13.5);
...
print(fig, '-dpdf', './Plots/plotconsist70.pdf');